...
################################################################
# This is a generated script based on design: sysclk_bd
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_125mhz [ create_bd_port -dir O -type clk clk_125mhz ]
  set clk_250mhz [ create_bd_port -dir O -type clk clk_250mhz ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {110.069} \
   CONFIG.CLKOUT1_PHASE_ERROR {83.589} \
   CONFIG.CLKOUT2_JITTER {92.841} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_125mhz] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_250mhz] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports clk_locked] [get_bd_pins clk_wiz_0/locked]
